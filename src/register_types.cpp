...
void initialize_gdextension_module(ModuleInitializationLevel p_level) {
    ...
    ClassDB::register_class<RapidXML>();
...
GDExtensionBool GDE_EXPORT rapidxml_library_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization) {
